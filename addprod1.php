...
<div class="container">
  ...
  <form role="form" method="post" action="transactionsave.php?action=adds">
                            ...
                            <h5><i class="fas fa-calendar"></i> DeliveryDate:<input readonly="" type="text" value="<?php echo date_format($date,'Y-m-d') ?>" name="del" style="width: 206px" required></h5><br>
                            <tr> 
...
<select id="myselection" name="paymethod"  class="form-control">
	<option>Select Option</option>
	 
   <option value="One">Cash on Delivery</option>
 <option value="Two">Online Transaction</option>
							...
							You have selected <input type="paymenthod" type="hidden" readonly="" value="Cash on Delivery">
	  Option <strong> <center><button type="submit" onclick="return confirm('Do you want to submit order?')" class="btn btn-lg btn-success">Submit Order</button></center></strong>.
</div>
<div id="showTwo" class="myDiv">

	<a href="online_payemt.php" class="btn btn-primary"><strong>Pay Now Online</strong>.</a>
</div>
