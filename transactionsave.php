...
if($_GET["action"]=='adds') {
  ...
  $query3 = "INSERT INTO tbltransacdetail(transac_code,date,customer_id,deliveryfee,pay_met,totalprice,status,delivery_date)VALUES('".$tat."','".$date."','".$_SESSION['cid']."',150,'".$_POST['paymethod']."','".$_SESSION['mm']."'+150,'Pending','".$del."')";
