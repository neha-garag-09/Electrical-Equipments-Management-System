...
if($_GET["action"]=='adds') {
  ...
  $query3 = "INSERT INTO tbltransacdetail(transac_code,date,customer_id,deliveryfee,pay_met,totalprice,status,delivery_date)VALUES('".$tat."','".$date."','".$_SESSION['cid']."',150,'".$paymenthod."','".$_SESSION['mm']."'+150,'Pending','".$del."')";
