...
?>
 ...
 <div class="card">
            ...
            <div class="card-header">
             ...
             <center><h2>New Seema Electricals</h2><p style="font-size: 20px">Regal Circle, Dharwad<br> Karnataka, India</p></center>
         </div>
            ...
            <div class="card-body">
              <div class="table-responsive">
                            <table cellpadding="4" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                  <?php                  
 					$query = "SELECT b.product_name,a.date,a.qty,a.price,product_image,a.total FROM tbltransac a,tblproducts b WHERE a.product_code=b.product_code AND a.transac_code='".$_GET['id']."' GROUP BY a.product_code";
                    $result = mysqli_query($db, $query) or die (mysqli_error($db));
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
							...
							?>
							<td><img src="product_image/<?php echo $row["product_image"]; ?>" style="width: 100px"></td>
							<?php               
                            echo '<td>'. $row['date'].'</td>';
                            echo '<td>'. $row['qty'].'</td>';
